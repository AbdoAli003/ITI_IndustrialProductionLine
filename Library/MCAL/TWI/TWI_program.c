...
TWI_ErrorStatus_t TWI_ErrorStatusSendStartConditionWithACK(void) {
  ...
  //	TWI_u8_TWCR |= (1 << TWI_u8_TWCR_TWINT) | (1 << TWI_u8_TWCR_TWSTA) | (1
  //<< TWI_u8_TWCR_TWEN);
...
TWI_ErrorStatus_t TWI_ErrorStatusSendRepeatedStartConditionWithACK(void) {
  TWI_ErrorStatus_t Local_ErrorStatus = NoError;
  TWI_u8_TWCR_REG |= (1 << TWI_u8_TWCR_TWINT) | (1 << TWI_u8_TWCR_TWSTA) |
                     (1 << TWI_u8_TWCR_TWEN);
  /*Send Start Condition Bit*/
 ...
 * **/
/*********************************************************************************/
/* *Copy_pu8ReceivedByte options: Address of variable to store the recieved
 * byte**/
/*********************************************************************************/
TWI_ErrorStatus_t
TWI_ErrorStatusMasterReadDataByteWithACK(u8 *Copy_pu8ReceivedByte) {
  TWI_ErrorStatus_t Local_ErrorStatus = NoError;
...
TWI_ErrorStatus_t
TWI_ErrorStatusMasterReadDataByteWithNACK(u8 *Copy_pu8ReceivedByte) {
  TWI_ErrorStatus_t Local_ErrorStatus = NoError;
