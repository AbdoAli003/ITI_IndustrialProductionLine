...
/*static const u8 KPD_Au8Keys[4][4] = {{'7', '4', '1', '#'},
                        {'8', '5', '2', '0'},
                        {'9', '6', '3', '='},
                        {'/', '*', '-', '+'}}; // 4x4 keypad*/
...
static const u8 KEYPAD_External_Keypad[4][4] = {{'1', '2', '3', 'A'},
                                               {'4', '5', '6', 'B'},
                                               {'7', '8', '9', 'C'},
                                               {'*', '0', '#', 'D'}};

/*static const u8 KPD_Au8AlphaKeys[4][4] = {{'A', 'E', 'I', 'M'},
                             {'B', 'F', 'J', 'N'},
                             {'C', 'G', 'K', 'O'},
                             {'D', 'H', 'L', 'P'}};*/

static const u8 KPD_Au8RowsPin[4] = {KPD_u8_R1_PIN, KPD_u8_R2_PIN, KPD_u8_R3_PIN,
                        KPD_u8_R4_PIN};
static const u8 KPD_Au8ColsPin[4] = {KPD_u8_C1_PIN, KPD_u8_C2_PIN, KPD_u8_C3_PIN,
                        KPD_u8_C4_PIN};
    ...
    for (Local_u8RowsCounter = 0; Local_u8RowsCounter < 4;
      ...
      for (Local_u8ColsCounter = 0; Local_u8ColsCounter < 4;
        ...
        if (Local_u8PinValue == DIO_u8_LOW) {
          ...
          *Copy_pu8ReturnedKey = KEYPAD_External_Keypad[Local_u8RowsCounter][Local_u8ColsCounter];
          Local_u8Flag = 1;
          break;
        }
      }
